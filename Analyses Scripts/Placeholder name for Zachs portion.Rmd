...
perc_land_farming_primary = perc_land_farming_primary %>% 
  ...
  ungroup() %>%
  mutate(percentage = acre / sum(acre)) #get percentage of land for farming vs not farming
...
```{r}
farmland_conversion_full_delta = read_csv('farmland_conversion_primary_secondary.csv') 
