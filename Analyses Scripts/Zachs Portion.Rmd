...
```{r}
delta_tracts_primary_secondary = readxl::read_xlsx('../Datasets/zonesTractsSeparated2020.updated.xlsx')
...
names_bins = c('15-19', '20-24','25-34', '35-44', '45-54', '60-64', '65-74', '75-84')
...
#write_csv(age_plot_data, '../Datasets/age_plot_data.csv')
```

And now the plot:

```{r}
age_plot_data$age = factor(age_plot_data$age, levels = c('Under 5 ', '5-9 ', '10-14 ', '15-19', '20-24', '25-34', '35-44', '45-54', '55-59 ', '60-64', '65-74', '75-84', '85 -over'))
...
```{r}
california_zip_codes = read_csv('../Datasets/California_Zip_Codes.csv')
zip_codes = read_csv('../Datasets/zipcodes.csv')
...
farmland_conversion_data = conversion_data_plot_secondary %>%
  group_by(Zone, From) %>%
  summarize(Acres = sum(Acres))

farmland_conversion_plot_full = ggplot(data = farmland_conversion_data) +
...
```{r}
park_use_data_brennan = read_csv('../Datasets/brannan_island_sra.csv')
